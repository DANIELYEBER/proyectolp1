...
<html>
    ...
    <body>
        <div>
            <c:url var="updateDepartamentosFilial"  value="actualizarDepartementosFi.upeu" />
            <fm:form modelAttribute="modeloDepartamentosFi" method="post" action="${updateDepartamentosFilial}">
                <table>
                    <tr>
